...
function Feed(props) {
    ...
    return (
        ...
        /* 페이지 전체 컨테이너 */
        <Div flexDirection="column" margin="5% auto 0 auto" justifyContent="start" alignItems="center" backgroundColor="white" width="28%" border="0.5px solid gray">
            <Div height="4rem">
                <Div width="20%" justifyContent="center" alignItems="center" >
                    <Img src={ProfileS} width="4vh"></Img>
                </Div>
                <Div justifyContent="start" alignItems="center">{feed.commenter1}</Div>
            ...
            <Div width="94%" flexDirection="column">
                ...
                <Div height="1rem" margin="0 0 3% 0">
                    <Div width="20%" justifyContent="start" alignItems="center" >{feed.commenter1}</Div>
                    <Div width="60%" justifyContent="start" alignItems="center">{feed.comment1}</Div>
                </Div>
                <Div height="1rem" margin="0 0 3% 0">
                    <Div width="20%" justifyContent="start" alignItems="center" >{feed.commenter2}</Div>
                    <Div width="60%" justifyContent="start" alignItems="center">{feed.comment2}</Div>
                    ...
                    <Div width="5%" justifyContent="end" alignItems="center">{feed.comment2Like}</Div>
                </Div>
            </Div>
            <Hr />
